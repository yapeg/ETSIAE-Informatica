program RaicesNewtonRaphson_Numerico
use function_root_search_module_RN
implicit none

	! Campiar parámetro (dimensión problema) según función escogida
	...
	iter_max = 1d5
	call NumericalNewtonRaphsonMethod_RN(x = x_0, f = i, dx = deltax, cota_error = cota_error, iter_max = iter_max)
